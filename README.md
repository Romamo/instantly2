...
```sh
npm install git+ssh://git@github.com:stainless-sdks/instantly2-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install instantly2`
...
1. Via the `INSTANTLY2_LOG` environment variable
...
const client = new Instantly2({
  logger: logger.child({ name: 'Instantly2' }),
...
const client = new Instantly2({ fetch });
```
...
```ts
import Instantly2 from 'npm:instantly2';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/instantly2-typescript/issues) with questions, bugs, or suggestions.
