...
```sh
npm install git+ssh://git@github.com:Romamo/instantly2.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/Romamo/instantly2/issues) with questions, bugs, or suggestions.
