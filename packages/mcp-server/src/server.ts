...
import { ClientOptions } from 'instantly2';
...
export { ClientOptions } from 'instantly2';
...
export function initMcpServer(params: {
  ...
  const client = new Instantly2(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new Instantly2({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
